...
function CreateToDoItems() {
    if (todoValue.value === "") {
      ...
      const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                      <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="pencil.svg" />
                      <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="delete.svg" /></div></div>`;
  ...
  function ReadToDoItems() {
    todo.forEach((element) => {
      ...
      ${
        style === ""
          ? ""
          : '<img class="todo-controls" src="check.svg" />'
      }</div><div>
      ${
        style === ""
          ? '<img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="pencil.svg" />'
  ...
  function UpdateToDoItems(e) {
    if (
      ...
      addUpdate.setAttribute("src", "check.svg");
      todoValue.focus();
    }
  }
  ...
  function UpdateOnSelectionItems() {
    ...
    addUpdate.setAttribute("src", "plus.svg");
    todoValue.value = "";
